    ...
    <ThemeContext.Provider value={{ isDark, toggleTheme }}>
      <HashRouter>
        ...
        <div className="min-h-screen text-[#2C3E2D] dark:text-[#E2E8D5] font-sans flex flex-col selection:bg-[#D4A373] selection:text-white">
          ...
          <div className="fixed inset-0 z-[-2] opacity-[0.03] pointer-events-none mix-blend-overlay"
            style={{
          ...
          <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1]">
            <div className="absolute -top-[10%] -right-[10%] w-[50vw] h-[50vw] bg-[#E5E7E1] dark:bg-[#232620] rounded-full blur-[128px] opacity-60 animate-float"></div>
            <div className="absolute top-[40%] -left-[10%] w-[40vw] h-[40vw] bg-[#D8DCD3] dark:bg-[#2A2E26] rounded-full blur-[128px] opacity-60 animate-float" style={{ animationDelay: '2s' }}></div>
          </div>
